...
TEST(test_gmo, empty_gmo_has_no_strings) {
  constexpr const std::uint8_t gmo_file[] = {
  ...
  gmo_parser p(gmo_file, sizeof(gmo_file));
...
TEST(test_gmo, little_endian_gmo_with_one_string) {
  gmo_parser p(little_endian_single_string_gmo_file,
               sizeof(little_endian_single_string_gmo_file));
...
TEST(test_gmo, big_endian_gmo_with_two_strings) {
  gmo_parser p(big_endian_two_string_gmo_file,
               sizeof(big_endian_two_string_gmo_file));
